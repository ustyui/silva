...
class Joints():
    ...
    def makemotion(self):
        ...
        time.sleep(0.1)
	t = time.time()
        self._payload[0] = 300*math.sin(2*math.pi*t)
        self._payload[1] = - 300*math.sin(2*math.pi*t)
        self._payload[42] = - 100*math.sin(2*math.pi*t)
        #self._payload[40] = - 100*math.sin(1.5*math.pi*t)
