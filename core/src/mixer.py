...
class Mixer():
    ...
    def __init__(self, dev_name):
        self._name = dev_name
        self._default, __void = utils.load_map()
        ...
        self._joint_min, self._joint_max = np.array(utils.load_map('limit'))
        ...
        # publishers
        self.pub = rospy.Publisher('/silva/joint_local/fusion', Evans, queue_size = 5)
        self.pub_d = rospy.Publisher('/silva/joint_local/default', Evans, queue_size = 2 )
        self.pub_s = rospy.Publisher('/silva/states', Float32MultiArray, queue_size = 2)
...
if __name__ == "__main__":
    ...
    if (param_config == 0):
        rospy.logfatal("Fail to load robot parameters. Check /params folder to ensure the yaml file are correctly set. Code 10")
