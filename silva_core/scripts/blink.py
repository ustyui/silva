...
class eyelid():
    ...
    def state_cb(self, msg):
        ...
        if msg.level == 4 and msg.msgid == 10:
    ...
    def rythem_d(self, _count):
        ...
        self._payload[1] = float(150 * self._eyelid[0])
        self._payload[2] = float(100 * self._eyelid[1])
