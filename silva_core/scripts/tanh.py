...
class tanh():
    ...
    def start(self):
        ...
        while not rospy.is_shutdown():
            ...
            self._payload[0] = (WEIGHT_AMP[0]*self._gene[0]) + _threshold[0]
            self._payload[1] = (WEIGHT_AMP[1]*self._gene[1]) + _threshold[1]
            self._payload[2] = (WEIGHT_AMP[2]*self._gene[2]) + _threshold[2]
            self._payload[3] = (WEIGHT_AMP[3]*self._gene[3]) + _threshold[3]
            self._payload[4] = (WEIGHT_AMP[4]*self._gene[4]) + _threshold[4]
