...
class neck():
    ...
    ### joy slave ###
    def joy_slave(self):
        self._payload[2] = int(self._neck_slave[0]*200)
        self._payload[3] = int(self._neck_slave[1]*200)
        self._payload[4] = int(self._neck_slave[2]*100)
    ...
    def start(self):
        ...
        while not rospy.is_shutdown():
            ...
            self._payload[0] = int(2.0*self._neck[0])
            self._payload[1] = int(self._neck[1])
            self._payload[2] = int(1*self._neck[2])       # changed by ise  orig:1   0.25
            self._payload[3] = int(2*self._neck[3])     # changed by ise  orig:2
            self._payload[4] = 0 #int(1.3*self._neck[4])
...
if __name__ == "__main__":
    ...
    nh = rospy.init_node("neck_motion")
