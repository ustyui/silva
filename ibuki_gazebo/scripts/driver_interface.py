...
defaults = [798, 310, 490, 505, 735, 739, 452, 495, 499, 531, 250, 546, 477, 502,
            483, 488, 480, 496]
...
class Joint():
	...
	def dict_making(self, dic):
         for (i,k) in enumerate(seq_of_jointname):
             dic[seq_of_jointname[k]] = (self._payload[k] - defaults[i])*0.33*0.0314
        
if __name__=="__main__":
	rospy.init_node("ibuki_simulation")
